...
package jp.progression.commands.lists {
	...
	/**
	 * <p>ShuttleList クラスは、登録された複数のコマンドを 1 つづつ順番に実行し、全て完了したら逆順で実行していくコマンドリストクラスです。</p>
	 * <p></p>
	 * 
	...
	public class ShuttleList extends SerialList implements IRepeatable {
		...
		/**
		 * <p>新しい ShuttleList インスタンスを作成します。</p>
		 * <p>Creates a new ShuttleList object.</p>
		 * 
		 * @param repeatCount
		 * <p>実行したいループ処理数です。</p>
		 * <p></p>
		...
		/**
		 * <p>ShuttleList インスタンスのコピーを作成して、各プロパティの値を元のプロパティの値と一致するように設定します。</p>
		 * <p>Duplicates an instance of an ShuttleList subclass.</p>
		 * 
		 * @return
		 * <p>元のオブジェクトと同じプロパティ値を含む新しい ShuttleList インスタンスです。</p>
		 * <p>A new ShuttleList object that is identical to the original.</p>
		 */
