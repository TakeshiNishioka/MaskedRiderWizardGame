...
package jp.progression.casts {
	...
	public class CastMovieClip extends ExMovieClip implements ICastObject, IManageable {
		...
		public function updateManager():Boolean {
			// ドキュメントクラスであれば
			if ( _isDocumentClass ) { return true; }
			...
			// シーンドキュメントクラスとして設定されていれば
			if ( Progression.progression_internal::$currentManager ) {
				_isDocumentClass = true;
				_manager = Progression.progression_internal::$currentManager;
				Progression.progression_internal::$currentManager = null;
			}
