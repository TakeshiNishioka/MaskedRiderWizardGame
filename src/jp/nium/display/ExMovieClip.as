...
package jp.nium.display {
	 ...
	 * <p>ExMovieClip class is a basic display object class used at jp.nium package which extends the basic function of MovieClip class.</p>
	 * 
	 ...
	 * </listing>
	 */
	public class ExMovieClip extends MovieClip implements IExDisplayObjectContainer, IIdGroup {
		
		/**
		 * @private
		 */
		nium_internal static var $collections:IdGroupCollection = new IdGroupCollection();
		 ...
		 * <p>Returns if the movement processing of the playback head is executing in the timeline of the MovieClip.</p>
		 * 
		 * @see #play()
		 * @see #stop()
		 * @see #switchAtPlaying()
		 ...
		 * <p>Moves the playback head in the timeline of the MovieClip.</p>
		 * 
		 * @see #isPlaying
		 */
		 ...
		 * <p>Stops the playback head in the MovieClip.</p>
		 * 
		 * @see #isPlaying
		 */
		 ...
		 * <p>Playback or stops according to the playback state of the MovieClip.</p>
		 * 
		 * @see #isPlaying
		 */
		 ...
		 * <p>Start the playback of the SWF file with the specified frame.</p>
		 * 
		 * @see #isPlaying
		 * 
		 * @param frame
		 ...
		 * <p>Set the palyback head to the specified frame of the MovieClip and stop at that point.</p>
		 * 
		 * @see #isPlaying
		 * 
		 * @param frame
		 ...
		 * <p>Move the playback head to the next frame and stop at that point.</p>
		 * 
		 * @see #isPlaying
		 */
		 ...
		 * <p>Move the playback head to the previous frame and stop at that point.</p>
		 * 
		 * @see #isPlaying
		 */
